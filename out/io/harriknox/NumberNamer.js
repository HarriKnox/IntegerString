...
var G__35 = io.harriknox.NumberNamer.split_pad_and_reverse_numbers.call(null,group_number);
var vec__36 = G__35;
...
var G__39 = [cljs.core.str(io.harriknox.NumberNamer.large_number_group_prefix.call(null,ones__$1,tens__$1,hundreds__$1)),cljs.core.str("illi"),cljs.core.str(suffix__$2)].join('');
G__35__$1 = G__38;
suffix__$1 = G__39;
continue;
}
...
return [cljs.core.str((function (){var pred__43 = cljs.core.re_find;
var expr__44 = [cljs.core.str(group_number)].join('');
if(cljs.core.truth_(pred__43.call(null,/^0*$/,expr__44))){
return "";
} else {
if(cljs.core.truth_(pred__43.call(null,/^0*1$/,expr__44))){
return "thousand";
} else {
...
var pred__49 = cljs.core.re_find;
var expr__50 = number_str;
if(cljs.core.truth_(pred__49.call(null,/^$/,expr__50))){
return "";
} else {
if(cljs.core.truth_(pred__49.call(null,/ree$/,expr__50))){
return clojure.string.replace.call(null,number_str,/ree$/,[cljs.core.str("ir"),cljs.core.str(suffix)].join(''));
} else {
if(cljs.core.truth_(pred__49.call(null,/ve$/,expr__50))){
return clojure.string.replace.call(null,number_str,/ve$/,[cljs.core.str("f"),cljs.core.str(suffix)].join(''));
} else {
if(cljs.core.truth_(pred__49.call(null,/t$/,expr__50))){
...
})()):cljs.core._conj.call(null,cljs.core.List.EMPTY,[cljs.core.str((function (){var G__55 = tens;
switch (G__55) {
case (2):
return "twenty";
...
var G__63 = io.harriknox.NumberNamer.split_pad_and_reverse_numbers.call(null,number);
var vec__64 = G__63;
var ones = cljs.core.nth.call(null,vec__64,(0),null);
var tens = cljs.core.nth.call(null,vec__64,(1),null);
var hundreds = cljs.core.nth.call(null,vec__64,(2),null);
var remaining = cljs.core.nthnext.call(null,vec__64,(3));
var group = (0);
...
while(true){
var vec__65 = G__63__$1;
var ones__$1 = cljs.core.nth.call(null,vec__65,(0),null);
var tens__$1 = cljs.core.nth.call(null,vec__65,(1),null);
var hundreds__$1 = cljs.core.nth.call(null,vec__65,(2),null);
var remaining__$1 = cljs.core.nthnext.call(null,vec__65,(3));
...
var G__69 = [cljs.core.str(quotient),cljs.core.str(cljs.core.quot.call(null,divisor,(3)))].join('');
var G__70 = cljs.core.rem.call(null,divisor,(3));
var G__71 = (counter + (1));
quotient = G__69;
remainder = G__70;
counter = G__71;
