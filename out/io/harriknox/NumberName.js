...
io.harriknox.NumberName.split_numbers = (function io$harriknox$NumberName$split_numbers(number){
...
io.harriknox.NumberName.split_and_pad_numbers = (function io$harriknox$NumberName$split_and_pad_numbers(number){
return cljs.core.concat.call(null,cljs.core.repeat.call(null,((2) - cljs.core.rem.call(null,(cljs.core.count.call(null,[cljs.core.str(number)].join('')) - (1)),(3))),(0)),io.harriknox.NumberName.split_numbers.call(null,number));
});
io.harriknox.NumberName.split_and_reverse_numbers = (function io$harriknox$NumberName$split_and_reverse_numbers(number){
return cljs.core.reverse.call(null,io.harriknox.NumberName.split_numbers.call(null,number));
});
io.harriknox.NumberName.split_pad_and_reverse_numbers = (function io$harriknox$NumberName$split_pad_and_reverse_numbers(number){
return cljs.core.reverse.call(null,io.harriknox.NumberName.split_and_pad_numbers.call(null,number));
});
io.harriknox.NumberName.decrement = (function io$harriknox$NumberName$decrement(number){
...
var G__36 = io.harriknox.NumberName.split_pad_and_reverse_numbers.call(null,group_number);
var vec__37 = G__36;
...
var G__40 = [cljs.core.str(io.harriknox.NumberName.large_number_group_prefix.call(null,ones__$1,tens__$1,hundreds__$1)),cljs.core.str("illi"),cljs.core.str(suffix__$2)].join('');
G__36__$1 = G__39;
suffix__$1 = G__40;
continue;
}
...
return [cljs.core.str((((group_number === (0)))?"":((cljs.core._EQ_.call(null,group_number,(1)))?"thousand":io.harriknox.NumberName.illion_group_name.call(null,io.harriknox.NumberName.decrement.call(null,group_number))
))),cljs.core.str(",")].join('');
});
...
var G__58 = io.harriknox.NumberName.split_pad_and_reverse_numbers.call(null,number);
var vec__59 = G__58;
...
io.harriknox.NumberName.divide_by_three = (function io$harriknox$NumberName$divide_by_three(number){
if(cljs.core.truth_((function (){var or__2822__auto__ = (cljs.core.integer_QMARK_.call(null,number)) && ((number >= (0)));
if(or__2822__auto__){
return or__2822__auto__;
} else {
...
var vec__69 = io.harriknox.NumberName.divide_by_three.call(null,exponent);
...
})()),cljs.core.str(" "),cljs.core.str(io.harriknox.NumberName.name_of_group.call(null,quotient))].join(''),/\s*,\s*$/,"");
});
